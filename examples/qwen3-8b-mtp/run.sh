#!/bin/bash
# Train an MTP draft model for Qwen3-8B from scratch.
# Reproduces: AngelSlim/Qwen3-8B-MTP-TTT3
#
...
#
# Usage:
#   ./examples/qwen3-8b-mtp/run.sh [EXTRA_ARGS...]
...
CONFIG_FILE="$ROOT_DIR/configs/vllm_qwen3_8b_mtp_pack_usp_40k.yaml"
...
echo "=============================================="
echo "MTP Training (from scratch) — Qwen3-8B"
echo "Reproduces: AngelSlim/Qwen3-8B-MTP-TTT3"
echo "=============================================="
