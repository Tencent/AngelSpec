#!/bin/bash
# Train a DFly draft model for Qwen3-8B from scratch.
# Reproduces: AngelSlim/Qwen3-8B-DFly-B8
#
...
#
# Usage:
#   ./examples/qwen3-8b-dfly/run.sh [EXTRA_ARGS...]
...
echo "=============================================="
echo "DFly Training (from scratch) — Qwen3-8B"
echo "Reproduces: AngelSlim/Qwen3-8B-DFly-B8"
echo "=============================================="
